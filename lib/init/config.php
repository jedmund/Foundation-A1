...
// Application constants
	...
	defined('DOMAIN') ? null : 
		define("DOMAIN", "http://dev.jedmund.com/");

// Directory constants	
	defined('DS') ? null : define('DS', DIRECTORY_SEPARATOR);
	
	defined('SITE_ROOT') ? null :
		define('SITE_ROOT', DS.'home'.DS.'justin'.DS.'public_html'.DS.'jedmund'.DS.'dev'.DS.'public');
	...
	defined('SLIB_PATH') ? null :
		define('SLIB_PATH', CLASS_PATH.DS.'social');
...
// Parsel libraries
	...
	require_once(PLIB_PATH.DS.'markup.php');
	require_once(PLIB_PATH.DS.'builder.php');

// Social libraries
	require_once(SLIB_PATH.DS.'twitter'.DS.'twitter.php');
	require_once(SLIB_PATH.DS.'dribbble'.DS.'dribbble.php');
