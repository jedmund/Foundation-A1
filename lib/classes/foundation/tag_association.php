 ...
 */
	...
	class Tag_Association {
		protected static $table = "tag_associations";
		protected static $fields = array("tid", "pid");
		 ...
		 * @param				$pid				The Project ID of the desired object.
		 * @param				$fields			The fields which we want to get.
		 * @return			$result			Object containing Tag information.
		 *
		 */
		public static function find_specific($tid, $pid, $fields=0) {
			global $db;
